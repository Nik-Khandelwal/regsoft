...
function retrieve_left(){
	...
	var csrf_token = getCookie('csrftoken');
	var ourRequest = new XMLHttpRequest();
	ourRequest.open("GET", "https://api.myjson.com/bins/qd2cn");	// method and url
	ourRequest.setRequestHeader("Content-type", "application/json");
	// ourRequest.setRequestHeader("X-CSRFToken", csrf_token);
...
function show_denominations(){
	...
	document.getElementById('return_bill_form').innerHTML = '<div class="row"> <div class="col s6 center deno_field">2000\'s</div><div class="col s6 center input-field"> <input type="number" name="ret_2000s" id="ret_deno_2000" value="0"> <label for="ret_deno_2000" class="lab"></label> </div><div class="col s6 center deno_field">500\'s</div><div class="col s6 center input-field"> <input type="number" name="ret_500s" id="ret_deno_500" value="0"> <label for="ret_deno_500" class="lab"></label> </div><div class="col s6 center deno_field">200\'s</div><div class="col s6 center input-field"> <input type="number" name="ret_200s" id="ret_deno_200" value="0"> <label for="ret_deno_200" class="lab"></label> </div><div class="col s6 center deno_field">100\'s</div><div class="col s6 center input-field"> <input type="number" name="ret_100s" id="ret_deno_100" value="0"> <label for="ret_deno_100" class="lab"></label> </div><div class="col s6 center deno_field">50\'s</div><div class="col s6 center input-field"> <input type="number" name="ret_50s" id="ret_deno_50" value="0"> <label for="ret_deno_50" class="lab"></label> </div></div>';

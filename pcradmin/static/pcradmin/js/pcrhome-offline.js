...
function openSpecificStats(num, id_col, id_sport, name, option) {
  ...
  ourRequest.onreadystatechange = function() {
    if (ourRequest.readyState === 4 && ourRequest.status === 200) {
      ...
      Materialize.toast('There was some error connecting to the server!', 3000);
      var jsonResponse = {"participants": [["Arpit Anshuman", 9829775537, "f2016250@pilani.bits-pilani.ac.in", "male", "Participant", 0, 1, 3],["Nikhil Khandelwal", 9090909090, "f2016192@pilani.bits-pilani.ac.in", "male", "Captain", 0, 1, 1],["Rampalli Sai Srivatsa", 8901234567, "f2016290@pilani.bits-pilani.ac.in", "male", "Coach", 1, 0, 2],["Piyali Manna", 1234567890, "f2016226@pilani.bits-pilani.ac.in", "female", "Participant", 1, 2, 4]]};
      var participants = jsonResponse.participants;
      for (var i = 0; i < participants.length; i++) {
        var confirmation = '';
        var payment = '';

  ...
  ourRequest.onreadystatechange = function() {
    if (ourRequest.readyState === 4 && ourRequest.status === 200) {
      ...
      for (var i = 0; i < unconfirmed.length; i++) {
        ...
        if (unconfirmed[i][4]==1&&unconfirmed[i][6]==1) {
          document.getElementById('unconfirmed-parts-view-docs-list-body').innerHTML += '<tr class="unconfirmed-parts-status-selection"> <td style="display: none;">'+unconfirmed[i][0]+'</td><td style="flex-basis: 35%;">'+unconfirmed[i][1]+'</td><td style="flex-basis: 35%">'+sports+'</td><td style="flex-basis: 10%;"><a href=\"'+unconfirmed[i][3]+'\" target="_blank"><i class="material-icons black-text">file_download</i></a></td><td style="flex-basis: 10%;"><a href=\"'+unconfirmed[i][5]+'\" target="_blank"><i class="material-icons black-text">file_download</i></a></td><td style="flex-basis: 10%"><i class="material-icons black-text change_cursor" onclick="toggleUnconfirmedPartDocsSelection(this)">check_box_outline_blank</i></td></tr>';
        } else if (unconfirmed[i][4]==1&&unconfirmed[i][6]==0) {
          document.getElementById('unconfirmed-parts-view-docs-list-body').innerHTML += '<tr class="unconfirmed-parts-status-selection"> <td style="display: none;">'+unconfirmed[i][0]+'</td><td style="flex-basis: 35%;">'+unconfirmed[i][1]+'</td><td style="flex-basis: 35%">'+sports+'</td><td style="flex-basis: 10%;"><a href=\"'+unconfirmed[i][3]+'\" target="_blank"><i class="material-icons black-text">file_download</i></a></td><td style="flex-basis: 10%;"><i class="material-icons black-text">block</i></td><td style="flex-basis: 10%"><i class="material-icons black-text change_cursor" onclick="toggleUnconfirmedPartDocsSelection(this)">check_box_outline_blank</i></td></tr>';
        } else if (unconfirmed[i][4]==0&&unconfirmed[i][6]==1) {
          document.getElementById('unconfirmed-parts-view-docs-list-body').innerHTML += '<tr class="unconfirmed-parts-status-selection"> <td style="display: none;">'+unconfirmed[i][0]+'</td><td style="flex-basis: 35%;">'+unconfirmed[i][1]+'</td><td style="flex-basis: 35%">'+sports+'</td><td style="flex-basis: 10%;"><i class="material-icons black-text">block</i></td><td style="flex-basis: 10%;"><a href=\"'+unconfirmed[i][5]+'\" target="_blank"><i class="material-icons black-text">file_download</i></a></td><td style="flex-basis: 10%"><i class="material-icons black-text change_cursor" onclick="toggleUnconfirmedPartDocsSelection(this)">check_box_outline_blank</i></td></tr>';
        } else {
          document.getElementById('unconfirmed-parts-view-docs-list-body').innerHTML += '<tr class="unconfirmed-parts-status-selection"> <td style="display: none;">'+unconfirmed[i][0]+'</td><td style="flex-basis: 35%;">'+unconfirmed[i][1]+'</td><td style="flex-basis: 35%">'+sports+'</td><td style="flex-basis: 10%;"><i class="material-icons black-text">block</i></td><td style="flex-basis: 10%;"><i class="material-icons black-text">block</i></td><td style="flex-basis: 10%"><i class="material-icons black-text change_cursor" onclick="toggleUnconfirmedPartDocsSelection(this)">check_box_outline_blank</i></td></tr>';
        }
      }
      for (var i = 0; i < confirmed.length; i++) {
        var sports = '';

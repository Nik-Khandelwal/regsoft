...
$(document).ready(function() {
 ...
 $(document).ready(function(){
  ...
  if(document.getElementById('UwqnpgHVZjOh')){
    // Do nothing
  } else {
    alert('Please Disable Adblock and refresh webpage. Some features of our website are blocked by adblock thus creating issues while registrations.');
  }
});

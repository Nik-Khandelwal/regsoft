    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function createSlideArrows(section){
            section.find(SLIDES_WRAPPER_SEL).after('<div class="' + SLIDES_ARROW_PREV + '"><img src="/static/main/Landing/images/left-arrow.svg" class="arrows"></div><div class="' + SLIDES_ARROW_NEXT + '"><img src="/static/main/Landing/images/right-arrow.svg" class="arrows"></div>');
